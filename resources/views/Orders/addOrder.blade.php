...
<!-- features-post-create.html  Tue, 07 Jan 2020 03:39:48 GMT -->
<head>
<meta charset="UTF-8">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Fill In Your Order Details</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Order Title</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" placeholder="e.g game programming" name="OrderTitle">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Subject</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" placeholder="e.g physics" name="subject">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Budget</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" placeholder="e.g $500" name="budget">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Due Date</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" class="form-control" placeholder="e.g physics" name="date">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Due Time</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="time" class="form-control" placeholder="e.g physics" name="time">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Academic Level</label>
                                        <div class="col-sm-12 col-md-7">
                                            <select class="form-control selectric" name="academiclevel">
                                                <option>High School</option>
                                                <option>Post Graduuate</option>
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Request type</label>
                                        <div class="col-sm-12 col-md-7">
                                            <select class="form-control selectric" name="requesttype">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Solution format</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" placeholder="e.g pdf or ms word document" name="solutionformat">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Upload nessesary files</label>
                                        <div class="col-sm-12 col-md-7">
                                            <div id="image-preview" class="image-preview">
                                                <label for="image-upload" id="image-label">Choose File</label>
                                                <input type="file" name="image" id="image-upload" name="files" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Comments & instructions</label>
                                        <div class="col-sm-12 col-md-7" name="comments">
...
<!-- features-post-create.html  Tue, 07 Jan 2020 03:39:49 GMT -->
</html>
